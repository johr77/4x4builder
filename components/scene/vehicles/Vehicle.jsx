...
const Vehicle = ({ spawnPosition = [0, 0, 0], spawnRotation = [0, 0, 0] }) => {
	...
	const colliderArgs = useMemo(() => [.88* SCALE,.5* SCALE,(wheelbase / 2 + axleHeight) * .45], [wheelbase, axleHeight])
	// colliderPosition
	...
	const colliderPosition = useMemo(() => [0,.9 * SCALE ,0])
	...
	return (
		<>
			<RigidBody ref={chassisRef} type='dynamic' position={spawnPosition}
				...
				<CuboidCollider args={colliderArgs} position={colliderPosition} mass={500} />
