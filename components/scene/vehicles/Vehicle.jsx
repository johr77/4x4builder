...
const Vehicle = ({ spawnPosition = [0, 0, 0], spawnRotation = [0, 0, 0] }) => {
	...
	return wheelPositions.map((wheel, i) => ({
		...
		position: new Vector3(wheel.position[0] * 0.6, wheel.position[1], wheel.position[2]),
	...
	const colliderArgs = useMemo(() => [.8, 0.4, wheelbase / 2 + axleHeight], [wheelbase, axleHeight])
	// colliderPosition
